#!/usr/bin/env python3
"""
run_039: Transductive Spatial GNN on geo_level_3 cliques.

Combines all Train and Test features, maps geo_level_3 to a contiguous index,
...
def main():
    ...
    # We need geo_level_3_id from the original data
    ...
    print(f"\n── Training Transductive GNN ({num_geo3} unique geo3, 5-fold CV) ──")
    ...
    rm.create_run(
        description=f"Transductive GeoSAGE GNN on run_012 features",
        model_type="PyTorch_GNN",
        feature_set=f"run_012_features+geo3_graph",
